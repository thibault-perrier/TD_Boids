    ...
    private void Update()
    {
        ...
        if (elapsedTime >= interval)
        {
            ...
            for (int i = 0; i <= boidsPerInterval; i++)
            {
                ...
                entitymanager.AddComponentData(e, new BoidComponentData
                {
                ...
                entitymanager.AddSharedComponentManaged(e, new RenderMeshUnmanaged
                {
                    mesh = mesh,
                    material = material,
        ...
        /*foreach (Entity e in debugEntities)
        {
            ...
            BoidComponentData bc = entitymanager.GetComponentData<BoidComponentData>(e);
            if (bc.debug >0)
            {
