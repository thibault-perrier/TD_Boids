...
public partial class BoidMovement : SystemBase
{
    public NativeParallelMultiHashMap<int, BoidComponentData> cellVsEntityPositions;
    ...
    {
        cellVsEntityPositions = new NativeParallelMultiHashMap<int, BoidComponentData>(0, Allocator.Persistent);
    }

    protected override void OnUpdate()
    {
        EntityQuery eq = GetEntityQuery(typeof(BoidComponentData));
        ...
        NativeParallelMultiHashMap<int, BoidComponentData>.ParallelWriter cellVsEntityPositionsParallel = cellVsEntityPositions.AsParallelWriter();
        Entities.ForEach((ref BoidComponentData bc, ref Translation trans) =>
        {
            BoidComponentData bcValues = new BoidComponentData();
            bcValues = bc;
        ...
        NativeParallelMultiHashMap<int, BoidComponentData> cellVsEntityPositionsForJob = cellVsEntityPositions;
        Entities.WithBurst().WithReadOnly(cellVsEntityPositionsForJob).ForEach((ref BoidComponentData bc, ref Translation trans, ref Rotation rot) =>
        {
